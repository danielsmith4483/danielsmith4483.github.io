	...
	App.prototype.render = function render() {
		return Object(preact_min["h"])(
			...
			Object(preact_min["h"])(Helmet_default.a, {
				title: 'Daniel Smith',
				meta: [{ name: 'description', content: 'I\'m Daniel, a software engineer with a background in Computer Science. I\'m passionate about delivering a good user experience, optimization, and web development.' }, { property: 'og:type', content: 'article' }, { property: 'og:site_name', content: 'danielsmith.io' }, { property: 'og:description', content: 'I\'m Daniel, a software engineer with a background in Computer Science. I\'m passionate about delivering a good user experience, optimization, and web development.' }, { property: 'og:image', content: 'https://storage.googleapis.com/danielsmith/photo.png' }, { property: 'og:url', content: 'https://danielsmith.io' }, { name: 'viewport', content: 'width=device-width, initial-scale=1' }, { name: 'keywords', content: 'danielsmith4483, Daniel Smith, software engineer, computer scientist' }]
			}),
			Object(preact_min["h"])(
